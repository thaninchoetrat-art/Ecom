        ...
        <div className="mt-6 pt-6 border-t flex flex-col items-center gap-4">
          <div className="flex flex-col items-center gap-1">
            <div className="flex items-center gap-3">
              ...
              {/* 🟢 ราคาที่โชว์คูณตามจำนวนที่เลือกแล้ว ไม่ใช่ราคาต่อชิ้นตายตัวเหมือนเดิม */}
              <span className="text-4xl font-extrabold text-pink-600">฿{(displayPrice * quantity).toLocaleString()}</span>
            </div>
            {quantity > 1 && (
              <span className="text-sm text-gray-400">฿{displayPrice.toLocaleString()} x {quantity} ชิ้น</span>
            )}
          </div>
