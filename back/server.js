...
import checkoutRoutes from './modules/checkout/checkoutRoutes.js'; // 🛒 ระบบสั่งซื้อสินค้าและชำระเงิน (แยกโฟลเดอร์ของตัวเอง)
...
app.use('/api/checkout', checkoutRoutes); // 🛒 ระบบสั่งซื้อสินค้าและชำระเงิน
